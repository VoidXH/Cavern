...
namespace Test.Cavern.QuickEQ.Format.Utilities;
...
static class FilterGraphNodeTestSteps {
    ...
    /// </summary>
    public static void AssertReachesOwnOutput(this IFilterGraphNode node) {
        ...
        HashSet<IFilterGraphNode> map = FilterGraphNodeUtils.MapGraph([node]);
    ...
    /// </summary>
    public static void AssertReachesOwnInput(this IFilterGraphNode node) {
        ...
        HashSet<IFilterGraphNode> map = FilterGraphNodeUtils.MapGraphBack([node]);
