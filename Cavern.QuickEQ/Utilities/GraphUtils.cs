...
namespace Cavern.QuickEQ.Utilities {
    /// <summary>
    /// Functions for processing and converting raw graphs that are stored as float arrays.
    /// For transforming curves, use the more versatile and safer <see cref="Equalizer"/> instead.
    /// </summary>
