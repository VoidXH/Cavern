                ...
                for (int i = 0; i < ChannelCount; i += 2) {
                    ...
                    if (Next != ChannelCount && AudioListener3D.Channels[i] != null && AudioListener3D.Channels[Next] != null)
                        AudioSource3D.Symmetric &=
                            ...
                            (AudioListener3D.Channels[i].X == AudioListener3D.Channels[Next].X ? AudioListener3D.Channels[i].Y % 180 ==
                            -AudioListener3D.Channels[Next].Y % 180 : AudioListener3D.Channels[i].Y % 180 == 0 && AudioListener3D.Channels[Next].Y % 180 == 0);
                }
            }
        }
    }
