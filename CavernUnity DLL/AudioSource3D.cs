...
namespace Cavern {
    ...
    public class AudioSource3D : MonoBehaviour {
        ...
        // ------------------------------------------------------------------
        /// <summary>The audio clip to play. If given, it will be converted to Cavern's <see cref="Clip"/> format.</summary>
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        /// <summary>Cached value of <see cref="Source.IsPlaying"/>, to prevent overriding auto-stops and playback functions.</summary>
