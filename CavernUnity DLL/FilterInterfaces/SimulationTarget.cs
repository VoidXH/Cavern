...
namespace Cavern.FilterInterfaces {
    ...
    public class SimulationTarget : AudioSource3D {
        /// <summary>Maximal sound travel time in samples, size of the convolution filter.</summary>
        ...
        /// <summary>Prepare this target for an <see cref="Impulse"/> response update.</summary>
        public void Prepare() => Impulse = new float[MaxSamples];

        /// <summary>Finalize a freshly generated impulse response.</summary>
