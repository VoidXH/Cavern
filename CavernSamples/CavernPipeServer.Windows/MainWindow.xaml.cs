...
public partial class MainWindow : Window {
    ...
    void StoreErrorMessage(Exception e) {
        if (e is CavernPipeLaunchTimeoutException) {
            Cavern.WPF.Consts.Language.Error((string)language["EPipe"]);
        } else if (e.GetType() == typeof(IOException) && e.Source == "System.IO.Pipes") {
