    ...
    partial class Distancer {
        ...
        static readonly float[][][] impulses = {
            ...
            new float[5][] {
                ...
                new float[] { .1129211f, 1, .1718559f, .1381525f, .1818777f, .06429848f, .03662953f, .01753195f, .00486109f,
                    4.179159E-05f },
            ...
            new float[5][] {
                new float[] { .004066892f, 1, .9276068f, .689859f, .6293351f, .3191521f, .215393f, .4407475f, .06752289f,
                    .02275242f, .002159857f, 5.570841E-05f },
                new float[] { .1883319f, 1, .3328354f, .2746456f, .7198558f, .2774538f, .2316711f, .2145967f, .09675916f,
                    .0682244f, .05688404f, .05102973f, .03165466f, .02654572f, .01556074f, .006934607f, .0006434356f },
                new float[] { .03379108f, .4993314f, .2378534f, .3391335f, .1794211f, .1522885f, .3848652f, 1, .3525296f, .09647691f,
                ...
                new float[] { 4.703207E-05f, 0, 1, .169429f, .1465525f, .1309407f, .1184505f, .09640431f, .08442533f,
