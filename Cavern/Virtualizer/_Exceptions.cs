...
namespace Cavern.Virtualizer {
    /// <summary>
    /// Tells if a ground channel is present, preventing an operation.
    /// </summary>
    public class NonGroundChannelPresentException : Exception {
        ...
        /// <summary>
        /// Tells if a ground channel is present and preventing an operation.
        /// </summary>
        public NonGroundChannelPresentException() : base(message) { }

        /// <summary>
        /// Tells if a ground channel is present and preventing an operation, with a custom message.
        /// </summary>
