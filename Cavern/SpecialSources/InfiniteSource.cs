...
namespace Cavern.SpecialSources {
    /// <summary>Important properties of concatenated clips don't match.</summary>
    public class InfiniteSourceMismatchException : Exception {
        /// <summary>Important properties of concatenated clips don't match.</summary>
        public InfiniteSourceMismatchException(string message) : base(message) { }
    }

    /// <summary>A <see cref="Source"/> with an intro <see cref="Clip"/> and a looping part after.</summary>
